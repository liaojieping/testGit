package com.cache.springbootcache.druidDateSourceConfig.MyException;
import com.cache.springbootcache.entity.ResponseData;
                         ...
                         HttpHeaders headers = new HttpHeaders();
                           ...
                           // do something with header or response
                               if ( 400 == responseEntity.getStatusCode().value() ) {
                                         System.out.println(body.getMessage());if ( "Bad credentials".equals(body.getMessage()) ) {
